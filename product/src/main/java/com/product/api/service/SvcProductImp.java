...
public class SvcProductImp implements SvcProduct {
    ...
    public ResponseEntity<DtoProductOut> getProductByGtin(String gtin) {
        try {
            ...
            if (product == null)
                throw new ApiException(HttpStatus.NOT_FOUND, "El gtin del producto no existe");

            DtoProductOut dto = repo.getProduct(product.getProduct_id());
            if (dto == null)
                throw new ApiException(HttpStatus.NOT_FOUND, "El gtin del producto no existe");
    ...
    @Override
    public ResponseEntity<String> decreaseStock(String gtin, Integer quantity) {
        try {
            Product product = repo.findByGtin(gtin);
            if (product == null)
                throw new ApiException(HttpStatus.NOT_FOUND, "El gtin del producto no existe");
            ...
            repo.decreaseStock(gtin, quantity);
